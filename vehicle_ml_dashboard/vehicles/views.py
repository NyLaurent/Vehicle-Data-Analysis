...
import pandas as pd
from django.shortcuts import render
from .dashboard import frequency_table,find_aggregate_things,display_crosstab_table,display_cross,display_pivot_table,visualizing_sales_with_sunburst_chart,visualizing_sales_world_map
...
def dashboard_view(request):
    ...
    "map":visualizing_sales_world_map(df)
    })
